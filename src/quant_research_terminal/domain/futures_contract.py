...
#: Retained name for the canonical-model base, which now lives in
#: :mod:`quant_research_terminal.domain.common`.
#:
#: The class moved because identity types in other packages need it, and
#: importing a leading-underscore name across a package boundary makes every
#: such import a private-API import. The alias keeps this module's established
#: spelling working unchanged; see the class docstring for what it guarantees
