...
def test_zero_volume_bar_is_rejected() -> None:
    # Decision: volume is a quantity in the shared numeric envelope, so an
    # empty period is represented by the absence of a bar. It reports a
    # quantity code — it previously reported non_decimal_price, which
    # misdescribed a count as a price.
